 ...
 *      Check if car with id exists. If Yes return 200. With message 'Car already exists'
...
/** Create PUT API.
 *  Check if car with id exists. If No return 200 with error 'No car with given id exist'.
...
app.put("/edit", (req, res) => {
  fs.readFile("./carsInfoData.json", "utf8", (err, jsonString) => {
    ...
    let result = json.map((car) => {
      console.log(
        "id is " + id + "car.id " + car.id + "name is " + req.body.name
      );
      if (car.id == id) {
...
/** Create Delete API.
 *  Check if car with id exists. If No return 200. With message 'No car with give id exists'
...
app.delete("/delete", (req, res) => {
  fs.readFile("./carsInfoData.json", "utf8", (err, jsonString) => {
    ...
    let id = req.body.id;
    console.log(id);
    let data = json.filter((car) => car.id != id) || [];
    console.log(data);
